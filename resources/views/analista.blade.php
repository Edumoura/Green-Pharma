    ...
    <div class="row justify-content-center">
        <div class="col-md-12">           
         @if(!isset($dadosArquivo))                   
            <form   method="POST" action="{{route('relatorioanalistabusca')}}" enctype="multipart/form-data">
               @csrf 
            ...
            <div class="col-md-12 table-overflow">
              <div class="col-md-12" style="margin-left:-28px;">
                    <div class="col-md-6" style="margin-top:10px;">
                      ...
                      <input style="width: 300px;" id=InputCamposAnalista type=text placeholder=Procurar..>    
                    </div>       
                  </div>
                 <table id="analista_tbarquivo"  class="table table-striped">
            ...
            <div class="row">
                <div class="col-md-12">
                    <a type="button" class="btn btn-primary" href="{{route('colaborador.dashboard')}}">Nova busca</a>
                </div>                        
            </div>
            @endif            
        </div>
...
<script type="text/javascript">
  ...
  $( document ).ready(function(){
    $("#InputCamposAnalista").on("keyup", function() {
      var value = $(this).val().toLowerCase();
      $("#analista_tbarquivo, #anali_tr").filter(function() {
          $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1)
      });   
    });
  });

  $("#InputCamposAnalista").click(function(){

    $("#InputCamposAnalista").val('');

  });

  var $table = document.getElementById("analista_tbarquivo"),
